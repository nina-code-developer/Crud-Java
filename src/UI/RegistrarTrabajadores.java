package UI;
import clases.DatosTrabajadores;
...
public class RegistrarTrabajadores extends javax.swing.JInternalFrame {
    ...
    void crearTabla(){
        ...
        dtmTrabajador.addColumn("DNI");
        dtmTrabajador.addColumn("Nombres");
        dtmTrabajador.addColumn("Apellidos");
        dtmTrabajador.addColumn("Direccion");
        dtmTrabajador.addColumn("Telefono");
        dtmTrabajador.addColumn("Sueldo");
